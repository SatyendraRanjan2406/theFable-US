      ...
      return (
        <div className="mt-2 space-y-4">
          ...
          <div className="space-y-4">
            ...
            {cartoonImageUrl ? (
              <div>
                <p className="text-center text-lg font-semibold text-purple-600 mb-4">
                ...
                <div className="flex justify-center gap-4 mt-4">
                  ...
                  <Button
                    ...
                    className="text-purple-600 hover:text-red-600 border-purple-300"
                  >
                    🎨 Remove Cartoon
                  </Button>
                </div>
              ...
              <div className="flex justify-center">
                <div className="relative">
                  ...
                  {/* Auto-select original photo for story when no cartoon exists */}
                  {uploadedImageUrl && !selectedForStory && (
                    <div className="text-center mt-2">
                      <Button
                        ...
                        className="bg-blue-500 hover:bg-blue-600 text-white rounded-xl py-2 px-4 text-sm"
                      >
                        📖 Use for Story
                      </Button>
                    </div>
          ...
          <div className="flex justify-center">
            <Button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-purple-50 to-pink-50 border-purple-300 hover:from-purple-100 hover:to-pink-100 disabled:opacity-50"
            >
